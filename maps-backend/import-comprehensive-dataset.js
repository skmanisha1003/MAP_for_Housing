...
// Comprehensive housing project data from the image
...
// NSW suburb coordinates with multiple coordinates for suburbs that appear multiple times
const suburbCoordinates = {
  ...
  "Bankstown": [
    ...
    { lat: -33.9200, lng: 151.0300 }, // Slightly offset
    { lat: -33.9150, lng: 151.0350 }  // Another offset
  ],
  "Wyee": [
    { lat: -33.1833, lng: 151.4833 }, // Base coordinates
    { lat: -33.1900, lng: 151.4800 }, // Slightly offset
    { lat: -33.1850, lng: 151.4850 }  // Another offset
  ],
  "Arncliffe": [
    { lat: -33.9333, lng: 151.1500 }, // Base coordinates
    { lat: -33.9300, lng: 151.1550 }  // Slightly offset
  ],
  "Blacktown": [
    { lat: -33.7667, lng: 150.9167 }, // Base coordinates
    { lat: -33.7700, lng: 150.9200 }  // Slightly offset
  ],
  "Thrumster": [
  ...
  "Maroubra": [
    { lat: -33.9500, lng: 151.2333 }, // Base coordinates
    { lat: -33.9450, lng: 151.2300 }  // Slightly offset
  ],
  "Wollongong": [
    { lat: -34.4333, lng: 150.8833 }, // Base coordinates
    { lat: -34.4300, lng: 150.8800 }  // Slightly offset
  ],
  "Regents Park": { lat: -33.8833, lng: 151.0167 },
  "South Kempsey": { lat: -31.0833, lng: 152.8333 },
  "Alexandria": [
    { lat: -33.9000, lng: 151.2000 }, // Base coordinates
    { lat: -33.9050, lng: 151.1950 }  // Slightly offset
  ],
...
async function importComprehensiveDataset() {
  try {
    console.log('🚀 Starting import of comprehensive housing project dataset...');
    ...
    console.log('\n🎉 Import complete! Successfully imported housing projects from comprehensive dataset.');
    console.log(`📊 Summary:`);
