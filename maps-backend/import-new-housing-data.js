...
async function importHousingData() {
  try {
    ...
    console.log('\n🎉 Import complete! Successfully imported housing projects.');
    console.log(`📊 Summary:`);
    console.log(`   - Total projects: ${importedCount}`);
    console.log(`   - Total dwellings across all projects: ${totalDwellings}`);
    console.log(`   - Total estimated NHAF funding: $${totalFunding.toFixed(2)}m`);
